...
const removeUserFcm = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(userFcmSchema_1.deleteUserFcmSchema, req.params);
    if (error != null) {
    ...
    try {
        ...
        userFcm.deleted = 1;
        void userFcm.save();
        const response = response_1.ResponseData.success('userFcm deleted successfully');
        logger_1.default.info(`Deleted userFcm with ID: ${userFcmId} successfully`);
...
exports.removeUserFcm = removeUserFcm;
