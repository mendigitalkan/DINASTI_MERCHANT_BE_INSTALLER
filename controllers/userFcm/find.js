...
const findAllUserFcm = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(userFcmSchema_1.findAllUserFcmSchema, req.query);
    if (error != null) {
    ...
    try {
        ...
        const certificates = await userFcm_1.UserFcmModel.findAndCountAll({
            where: {
                deleted: { [sequelize_1.Op.eq]: 0 },
                ...(Boolean(search) && {
                    [sequelize_1.Op.or]: [{ userFcmId: { [sequelize_1.Op.like]: `%${search}%` } }]
                })
            },
            order: [['id', 'desc']],
            ...(pagination === 'true' && {
...
exports.findAllUserFcm = findAllUserFcm;
