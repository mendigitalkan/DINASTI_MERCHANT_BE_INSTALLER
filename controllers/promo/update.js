...
const updatePromo = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(promoSchema_1.updatePromoSchema, req.body);
    if (error != null) {
    ...
    try {
        const notification = await promotions_1.PromoModel.findOne({
            where: {
                ...
                promoId: { [sequelize_1.Op.eq]: value.promoId }
            }
        });
        ...
        logger_1.default.info(`Updated notification with ID: ${value.promoId} successfully`);
